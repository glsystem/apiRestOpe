...
class FuncionarioController extends Controller
{
    ...
    public function get($id)
    {
        try {
            ...
            return response()->json($this->customResponse->tratativeSucess(true, "", Response::HTTP_OK, null, null, $this->service->get($id)), Response::HTTP_OK);
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json($this->customResponse->tratativeSucess(true, "", Response::HTTP_CREATED, null, null, $this->service->store($request->all())), Response::HTTP_CREATED);
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json($this->customResponse->tratativeSucess(true, "", Response::HTTP_OK, null, null, $this->service->detroy($id)), Response::HTTP_OK);
